...
export const RECONCILIATION_RULES: readonly ReconciliationRule[] = [
  ...
  },
  {
    ...
    tolerancePct: 0,
    blocksFiling: false,
    description: "Invoice number vs. EUR.1 certificate invoice reference",
  },
  {
    id: "ARRIVAL_NOTICE_BL_REF",
    fieldKey: "billOfLadingNumber",
    docTypeA: "Lading",
    docTypeB: "Arrival Notice",
    discrepancyType: "REFERENCE",
    normalizationFn: "text",
    tolerancePct: 0,
    blocksFiling: false,
    description: "Bill of lading number vs. arrival notice B/L or AWB reference",
  },
  {
    id: "BOOKING_NUM_FWDINSTR_SHIPINSTR",
    fieldKey: "bookingNumber",
    docTypeA: "Forwarding Instruction",
    docTypeB: "Shipping Instruction",
    discrepancyType: "REFERENCE",
    normalizationFn: "text",
    tolerancePct: 0,
    blocksFiling: false,
    description: "Forwarding instruction booking number vs. shipping instruction booking number",
  },
  {
    id: "BOOKING_NUM_BOOKINGREQ_FWDINSTR",
    fieldKey: "bookingNumber",
    docTypeA: "Booking Request",
    docTypeB: "Forwarding Instruction",
    discrepancyType: "REFERENCE",
    normalizationFn: "text",
    tolerancePct: 0,
    blocksFiling: false,
    description: "Booking request booking number vs. forwarding instruction booking number",
  },
  {
    id: "BOOKING_NUM_BOOKINGREQ_SHIPINSTR",
    fieldKey: "bookingNumber",
    docTypeA: "Booking Request",
    docTypeB: "Shipping Instruction",
    discrepancyType: "REFERENCE",
    ...
    tolerancePct: 0,
    blocksFiling: false,
    description: "Booking request booking number vs. shipping instruction booking number",
  },

  // ── Preference / origin-evidence documents ──────────────────────────────────
  {
    id: "ORIGIN_EUR1_INV",
    fieldKey: "countryOfOrigin",
    docTypeA: "EUR.1",
    ...
    tolerancePct: 0,
    blocksFiling: true,
    description: "EUR.1 certificate origin vs. invoice declared country of origin",
  },
  {
    id: "ORIGIN_EUR1_COO",
    fieldKey: "countryOfOrigin",
    docTypeA: "EUR.1",
    docTypeB: "Certificate of Origin",
    discrepancyType: "ORIGIN",
    normalizationFn: "text",
    tolerancePct: 0,
    blocksFiling: true,
    description: "EUR.1 certificate origin vs. certificate of origin",
  },
  {
    id: "ORIGIN_ATR_INV",
    fieldKey: "countryOfOrigin",
    ...
    tolerancePct: 0,
    blocksFiling: true,
    description: "A.TR certificate exporting country vs. invoice declared country of origin",
  },
  {
    id: "ORIGIN_ATR_COO",
    fieldKey: "countryOfOrigin",
    ...
    tolerancePct: 0,
    blocksFiling: true,
    description: "A.TR certificate exporting country vs. certificate of origin",
  },

  // ── Transport documents (sea waybill) ───────────────────────────────────────
  {
    id: "WEIGHT_SEAWB_PACK",
    fieldKey: "grossWeight",
    docTypeA: "Sea Waybill",
    docTypeB: "Packing",
    discrepancyType: "WEIGHT",
    normalizationFn: "weight_unit",
    tolerancePct: 5,
    blocksFiling: false,
    description: "Sea waybill gross weight vs. packing list gross weight",
  },
  {
    id: "WEIGHT_SEAWB_INV",
    fieldKey: "grossWeight",
    ...
    tolerancePct: 5,
    blocksFiling: false,
    description: "Sea waybill gross weight vs. invoice gross weight",
  },

  // ── Customs entry / government filings ──────────────────────────────────────
  {
    id: "VAL_INV_CUSTENTRY",
    fieldKey: "totalValue",
    docTypeA: "Invoice",
    docTypeB: "Customs Entry",
    discrepancyType: "VALUE",
    normalizationFn: "currency_amount",
    tolerancePct: 2,
    blocksFiling: true,
    description: "Invoice total value vs. customs entry declared value",
  },
  {
    id: "QTY_INV_CUSTENTRY",
    fieldKey: "totalQuantity",
    docTypeA: "Invoice",
    docTypeB: "Customs Entry",
    discrepancyType: "QUANTITY",
    ...
    tolerancePct: 0,
    blocksFiling: true,
    description: "Invoice quantity vs. customs entry declared quantity",
  },
  ...
  // ── Road transport (CMR) ─────────────────────────────────────────────────────
  {
    ...
    tolerancePct: 5,
    blocksFiling: false,
    description: "Invoice quantity vs. CMR consignment note quantity",
  },
];
