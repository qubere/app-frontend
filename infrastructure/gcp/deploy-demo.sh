...
for secret in "${DATABASE_URL_SECRET}" "${DIRECT_URL_SECRET}" "${PRODUCT_HELP_DATABASE_URL_SECRET}" "${CLERK_SECRET_KEY_SECRET}" "${GEMINI_API_KEY_SECRET}" "${CRON_SECRET_SECRET}" "${DOCLING_API_KEY_SECRET}" "${RESEND_API_KEY_SECRET}"; do
